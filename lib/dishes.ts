export const DISH_TAGS = ["主食","鸡肉","鸭肉","牛肉","猪肉","鱼肉","蔬菜","豆制品"] as const;
...
export const sampleDishes: DishRecord[] = [
  ...
  { id:"golden-shrimp",name:"金沙大虾",category:"炒菜",price:108,tags:[],isPublished:true,image:"/hero-feast.png",description:"大虾外酥里嫩，裹上咸蛋黄金沙，香浓而不腻。" },
